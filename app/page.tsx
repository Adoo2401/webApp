      ...
      <div className="grid  items-center md:grid-cols-2 mt-[40px] md:mt-[70px]">
        <div className="order-2 md:order-1">
          ...
          <div className="mt-[60px] flex space-x-6">
            <button className="bg-[#47B2E4] text-white rounded-full px-10 py-2">Log In</button>
            <button className="border border-[#47B2E4] rounded-full px-10 py-2">Register</button>
          </div>
        </div>
